        ...
        <Layout
            ...
            <main className='p-4 md:p-12'>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                    ...
                    <OrganizationCard name='xRealityLabs' description={'xRealityLabs is empowering industry transformations in AEC (Architecture, Engineering, Construction), Manufacturing, Education, and Healthcare.'} logoSrc={'img/xrealitylabs_logo.png'} url={'https://www.xrealitylabs.com/'} />
                ...
                <ul>
                    ...
                    <li><a href='https://github.com/Cangi' title='Stephen Hodgson'><Text compact>Rony Portelli</Text></a></li>
                </ul>
            </main>
        </Layout>
    );
