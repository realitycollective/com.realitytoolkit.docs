        ...
        <Layout
            ...
            <main className='p-4 md:p-12'>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                    <TeamMemberCard name={'Dino Fejzagić'} description={'Dino is a seasoned Unity developer and has been leading development of the Reality Toolkit. He\'s passionate about mixed reality technology and operates a consultancy for enterprise mixed reality solutions in Germany. Whenever he can catch a break from work, he also loves to work on his VR games. Some of them might actually make it to release, hopefully.'} imageSrc={'img/dino.png'} gitHubProfile={'https://github.com/FejZa'} xProfile={'https://x.com/_din0m1te'} />
